                        ...
                        <label for="series" class="form-label">
                            ...
                            <i class="bi bi-question-circle text-primary ms-1"
                             ...
                             <div class='text-center'>
                                 <strong class='d-block mb-1'>Где найти серию</strong>
                                 <img src='{{ asset('images\Series.jpg') }}'
                    ...
                    <div class="col-md-6">
                        <label for="number" class="form-label">
                            ...
                            <i class="bi bi-question-circle text-primary ms-1"
                               ...
                               data-bs-content="
                             <div class='text-center'>
                                 <strong class='d-block mb-1'>Где найти номер</strong>
                                 <img src='{{ asset('images/Number.jpg') }}'
                                      class='img-fluid rounded'
                                      style='max-width:260px;'>
                             </div>
                           ">
